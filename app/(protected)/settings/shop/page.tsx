          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              ...
              <div className="flex items-start gap-4">
                <div className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl border border-[var(--brand-border)] bg-[var(--brand-soft)] text-[var(--brand-accent)] shadow-lg dark:shadow-none">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                ...
                onClick={loadInfo}
                disabled={loading}
                className="h-11 rounded-2xl bg-[var(--brand-primary)] font-bold text-white shadow-lg hover:brightness-110"
              >
                {loading ? (
