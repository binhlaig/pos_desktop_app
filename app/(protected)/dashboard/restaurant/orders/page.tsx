...
export default function RestaurantOrdersPage() {
  ...
  */
  ...
  return (
    <main className="min-h-screen bg-slate-100 p-3 text-slate-950 sm:p-4">
      ...
      <style jsx global>{`
        @media (min-width: 768px) and (max-width: 1279px) and (orientation: landscape) {
          ...
          .restaurant-orders-table th,
          .restaurant-orders-table td {
            padding: 10px 6px;
            overflow-wrap: anywhere;
            white-space: normal;
          }
          .restaurant-orders-table th { font-size: 10px; letter-spacing: 0; }
          .restaurant-orders-table th:nth-child(1) { width: 18%; }
          .restaurant-orders-table th:nth-child(2) { width: 12%; }
          .restaurant-orders-table th:nth-child(3) { width: 11%; }
          .restaurant-orders-table th:nth-child(4) { width: 12%; }
          .restaurant-orders-table th:nth-child(5) { width: 12%; }
          .restaurant-orders-table th:nth-child(6) { width: 11%; }
          .restaurant-orders-table th:nth-child(7) { width: 14%; }
          .restaurant-orders-table th:nth-child(8) { width: 10%; }
          .restaurant-orders-table td span { max-width: 100%; padding-left: 6px; padding-right: 6px; }
          .restaurant-orders-table td svg { flex-shrink: 0; }
          .restaurant-orders-table .order-row-actions { flex-wrap: wrap; gap: 4px; }
          .restaurant-orders-table .order-row-actions button {
            width: 36px;
            min-height: 44px;
            padding: 6px;
          ...
          .restaurant-orders-table .order-action-label { display: none; }
        }
      `}</style>
      ...
      <div className="mx-auto flex max-w-[1600px] flex-col gap-3">
        <section className="bg-slate-100 py-2">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <h1 className="text-lg font-black">Restaurant Orders</h1>

            <div className="flex items-center gap-2">
              <button
                onClick={resetFilters}
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-3 py-2 text-xs font-bold text-[var(--brand-primary)] transition hover:brightness-95"
              >
                <Trash2 size={17} />
                Reset
              </button>
              ...
              <button
                ...
                disabled={loading}
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--brand-primary)] px-3 py-2 text-xs font-bold text-white shadow-lg shadow-[color-mix(in_srgb,var(--brand-primary)_20%,transparent)] transition hover:brightness-95 disabled:opacity-60"
              >
                {loading ? (
        ...
        <section className="bg-slate-100 py-1">
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-[minmax(0,1fr)_150px_160px_auto]">
            <div className="flex items-center gap-2 min-w-0 rounded-xl bg-white px-3 py-2 ring-1 ring-slate-200">
            ...
            <select
              ...
              className="min-h-10 min-w-0 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-bold outline-none"
            >
            ...
            <div className="rounded-xl bg-white px-3 py-2 text-center text-xs font-bold text-[var(--brand-primary)] ring-1 ring-[var(--brand-border)]">
            ...
            {statusOptions.map((status) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex shrink-0 items-center gap-2 min-h-10 rounded-xl px-3 py-2 text-xs font-bold transition ${
                    active
        ...
        {loading ? (
          ...
          <section className="overflow-hidden rounded-[2rem] border border-white/80 bg-white shadow-sm">
            ...
            <div className="overflow-x-auto">
              <table className="restaurant-orders-table w-full min-w-[960px] border-collapse text-left">
                    ...
                    return (
                      <tr key={`order-${order.id}`} className="bg-white hover:bg-slate-50">
                        ...
                        <td className="px-4 py-4 align-top text-right">
                          <div className="order-row-actions flex justify-end gap-2">
                            <button
                              type="button"
                              aria-label={`View order ${order.orderNo || order.id}`}
                              title="View order"
                            ...
                            >
                              <Eye size={16} />
                              <span className="order-action-label">View</span>
                            </button>
                            <button
                              type="button"
                            ...
                            >
                              <Printer size={16} />
                              <span className="order-action-label">Re-print</span>
                            </button>
                          </div>
                        </td>
                      </tr>
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h3 className="mt-1 break-words text-xl font-black tabular-nums text-slate-950">{value}</h3>
